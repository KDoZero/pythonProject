...
slice_without_step = my_list[1:9:2] #1,3,5,7

# 인덱싱, 슬라이스 실습
# 주민등록번호 자르기 : 하위 7자리중 첫번째 글자는 성별, 앞의 6자리는 년,월,일을 의미
jumin = "980127-1234567"
print("성별 : " + jumin[7])
...
print(a_str2.count("l"))
print(len(a_str2)) # 문자열 길이를 반환하는 함수
print(a_str2.__len__()) #문자열 길이를 반환하는 내장함수

# 문자열 찾기 : find() - 문자열 인덱스 반환, 없으면 -1
# rfind() - 뒤에서 문서 문자열을 찾고 찾은 인덱스는 앞에서 계산
